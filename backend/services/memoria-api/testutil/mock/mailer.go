...
// Source: domain/interfaces/mailer.go
//
...
func (m *MockMailer) Send(ctx context.Context, dto interfaces.MailerSendDTO) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", ctx, dto)
	ret0, _ := ret[0].(error)
	return ret0
}

// Send indicates an expected call of Send.
func (mr *MockMailerMockRecorder) Send(ctx, dto any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockMailer)(nil).Send), ctx, dto)
}
